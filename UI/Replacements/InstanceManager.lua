------------------------------------------------------------------
------------------------------------------------------------------
local tTrackedInstances = {IntelOverviewGovernmentInstance=true, PlayerPanel=true, DiplomacyRibbonLeader=true,
						   DiplomacyRibbonVert=true}
InstanceManager =
{
	------------------------------------------------------------------
	-- default values
	...
	new = function(self, instanceName, rootControlName, ParentControl)
		...
		if tTrackedInstances[instanceName] then
			if ExposedMembers.SlthInstances == nil then
				print('setting ExposedMembers SlthInstances')
				ExposedMembers.SlthInstances = {}
			end
			print('tracking', instanceName)
			ExposedMembers.SlthInstances[instanceName] = o
		end
