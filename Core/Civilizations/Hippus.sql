...
('LEADER_TASUNKE', 'LOC_LEADER_TASUNKE_NAME', 'LEADER_DEFAULT'),
('LEADER_RHOANNA', 'LOC_LEADER_RHOANNA_NAME', 'LEADER_DEFAULT');
...
('LEADER_RHOANNA', 'SLTH_CIVILIZATION_HIPPUS', 'LOC_CITY_HIPPUS_1_NAME');
...
('SLTH_CIVILIZATION_HIPPUS', 'NULL_CIVILIZATION_HIPPUS');

INSERT INTO Traits(TraitType, Name, Description) VALUES
('NULL_CIVILIZATION_HIPPUS', 'LOC_SLTH_HIPPUS_BANBUILDING_NULL_NAME', 'LOC_NULL_DESCRIPTION'),
...
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_HIPPUS_ALCHEMY_LAB');
...
('SLTH_UNIT_MERCENARY_MOUNTED', 'LOC_SLTH_UNIT_MERCENARY_MOUNTED_NAME', '2', '3', '24', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_MERCENARY_MOUNTED_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MERCENARY_MOUNTED', '0', 'PROMOTION_CLASS_LIGHT_CAVALRY', NULL, NULL, '0', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0', '1'),
('SLTH_UNIT_MAGNADINE', 'LOC_SLTH_UNIT_MAGNADINE_NAME', '2', '4', '53', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '360', '0', 'LOC_SLTH_UNIT_MAGNADINE_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MAGNADINE', '0', 'PROMOTION_CLASS_LIGHT_CAVALRY', 'TECH_WARHORSES', NULL, '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '0', '1');
...
('LEADER_TASUNKE', 'KIND_LEADER'),
('LEADER_RHOANNA', 'KIND_LEADER'),
