...
('LEADER_TEBRYN', 'LOC_LEADER_TEBRYN_NAME', 'LEADER_DEFAULT'),
('LEADER_OS_GABELLA', 'LOC_LEADER_OS_GABELLA_NAME', 'LEADER_DEFAULT');
...
('LEADER_OS_GABELLA', 'SLTH_CIVILIZATION_SHEAIM', 'LOC_CITY_SHEAIM_1_NAME');
...
('SLTH_CIVILIZATION_SHEAIM', 'SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH'),
('SLTH_CIVILIZATION_SHEAIM', 'SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON'),
('SLTH_CIVILIZATION_SHEAIM', 'SLTH_TRAIT_CIVILIZATION_UNIT_CHAOS_MARAUDER'),
('SLTH_CIVILIZATION_SHEAIM', 'SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS'),
('SLTH_CIVILIZATION_SHEAIM', 'SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER');
...
('NULL_CIVILIZATION_SHEAIM', 'LOC_SLTH_SHAIM_BAN_BUILDING_NULL_NAME', 'LOC_NULL_DESCRIPTION'),
...
('SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH_DESCRIPTION'),
('SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON_DESCRIPTION'),
('SLTH_TRAIT_CIVILIZATION_UNIT_CHAOS_MARAUDER', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_CHAOS_MARAUDER_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_CHAOS_MARAUDER_DESCRIPTION'),
('SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS_DESCRIPTION'),
('SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER_DESCRIPTION');
...
('SLTH_BUILDING_NULL_CIVILIZATION_SHEAIM_TRAINING_YARD', 'LOC_SLTH_BUILDING_BANNED_TRAINING_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_SHEAIM', NULL, 'ADVISOR_RELIGIOUS', '1');
...
('SLTH_UNIT_PYRE_ZOMBIE', 'LOC_SLTH_UNIT_PYRE_ZOMBIE_NAME', '2', '1', '14', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '60', '0', 'LOC_SLTH_UNIT_PYRE_ZOMBIE_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_PYRE_ZOMBIE', '0', 'PROMOTION_CLASS_MELEE', 'TECH_BRONZE_WORKING', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_EATER_OF_DREAMS', 'LOC_SLTH_UNIT_EATER_OF_DREAMS_NAME', '2', '1', '24', '5', '2', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '1', 'LOC_SLTH_UNIT_EATER_OF_DREAMS_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_EATER_OF_DREAMS', '0', 'PROMOTION_CLASS_ADEPT', 'TECH_STRENGTH_OF_WILL', NULL, '0', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_MAGIC', '0', 'ADVISOR_CONQUEST', '0');
...
('SLTH_UNIT_MOBIUS_WITCH', 'LOC_SLTH_UNIT_MOBIUS_WITCH_NAME', '2', '1', '19', '24', '2', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '1', 'LOC_SLTH_UNIT_MOBIUS_WITCH_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH', '0', 'PROMOTION_CLASS_ADEPT', NULL, NULL, '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_MAGIC', '0', 'ADVISOR_TECHNOLOGY', '0', NULL, '1'),
('SLTH_UNIT_REVELERS', 'LOC_SLTH_UNIT_REVELERS_NAME', '2', '2', '29', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_REVELERS_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER', '0', 'PROMOTION_CLASS_RECON', 'TECH_MATHEMATICS', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0', NULL, '1'),
('SLTH_UNIT_TAR_DEMON', 'LOC_SLTH_UNIT_TAR_DEMON_NAME', '2', '1', '10', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_TAR_DEMON_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON', '0', 'PROMOTION_CLASS_DISCIPLE', NULL, 'CIVIC_CORRUPTION_OF_SPIRIT', '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0', NULL, '1'),
('SLTH_UNIT_SUCCUBUS', 'LOC_SLTH_UNIT_SUCCUBUS_NAME', '2', '2', '19', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_SUCCUBUS_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS', '0', 'PROMOTION_CLASS_MELEE', 'TECH_SANITATION', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0', NULL, '1');
...
('SLTH_TRAIT_CIVILIZATION_UNIT_MOBIUS_WITCH', 'KIND_TRAIT'),
('SLTH_TRAIT_CIVILIZATION_UNIT_TAR_DEMON', 'KIND_TRAIT'),
('SLTH_TRAIT_CIVILIZATION_UNIT_CHAOS_MARAUDER', 'KIND_TRAIT'),
('SLTH_TRAIT_CIVILIZATION_UNIT_SUCCUBUS', 'KIND_TRAIT'),
('SLTH_TRAIT_CIVILIZATION_UNIT_REVELLER', 'KIND_TRAIT'),
('SLTH_CIVILIZATION_SHEAIM', 'KIND_CIVILIZATION'),
('LEADER_TEBRYN', 'KIND_LEADER'),
('LEADER_OS_GABELLA', 'KIND_LEADER'),
