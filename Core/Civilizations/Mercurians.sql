...
('MODIFIER_SLTH_INSTANT_LOYALTY_LOSS_IF_NOT_MERCURIAN', 'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN', '0', '0', NULL);
...
('MODIFIER_SLTH_INSTANT_LOYALTY_LOSS_IF_NOT_MERCURIAN', 'Amount', 'ARGTYPE_IDENTITY', '-110');
...
('SLTH_BUILDING_MERCURIAN_GATE', 'MODIFIER_SLTH_INSTANT_LOYALTY_LOSS_IF_NOT_MERCURIAN');
