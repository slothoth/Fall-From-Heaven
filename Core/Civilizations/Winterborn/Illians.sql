...
('SLTH_CIVILIZATION_ILLIANS', 'SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA'),
('SLTH_CIVILIZATION_ILLIANS', 'SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED'),
...
('SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED_DESCRIPTION'),
('SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA_NAME', 'LOC_SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA_DESCRIPTION');
...
('SLTH_TRAIT_CIVILIZATION_ILLIANS_COOL', 'TRAIT_GRANT_WINTERBORN_ABILITY_TUNDRA_SNOW_STRENGTH_CITY_ATTACH');

INSERT INTO Modifiers(ModifierId, ModifierType, RunOnce, Permanent, SubjectRequirementSetId) VALUES
('MODIFIER_SLTH_ILIAN_BONUS_FOOD_SNOW', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', '0', '0', 'FROSTLING_ABILITY_TERRAIN_STRENGTH_SNOW_REQS'),     -- borrowed from Racials, tests its snow or snow hills
...
('SLTH_UNIT_WILBOMAN', 'LOC_SLTH_UNIT_WILBOMAN_NAME', '2', '1', '34', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '360', '0', 'LOC_SLTH_UNIT_WILBOMAN_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_WILBOMAN', '0', 'PROMOTION_CLASS_MELEE', 'TECH_IRON_WORKING', NULL, '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '0', NULL, '0'),
('SLTH_UNIT_HIGH_PRIEST_OF_WINTER', 'LOC_SLTH_UNIT_HIGH_PRIEST_OF_WINTER_NAME', '2', '1', '29', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '0', 'LOC_SLTH_UNIT_HIGH_PRIEST_OF_WINTER_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_HIGH_PRIEST_OF_WINTER', '0', 'PROMOTION_CLASS_DISCIPLE', NULL, 'CIVIC_THEOLOGY', '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_MAGIC', '0', 'ADVISOR_CONQUEST', '0', NULL, '1'),
('SLTH_UNIT_AURIC_ASCENDED', 'LOC_SLTH_UNIT_AURIC_ASCENDED_NAME', '2', '3', '144', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_AURIC_ASCENDED_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED', '0', NULL, 'TECH_OMNISCIENCE', NULL, '0', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '1', NULL, '1'),
('SLTH_UNIT_DRIFA', 'LOC_SLTH_UNIT_DRIFA_NAME', '2', '3', '68', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '-1', '0', 'LOC_SLTH_UNIT_DRIFA_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA', '0', 'PROMOTION_CLASS_BEAST', NULL, 'CIVIC_DIVINE_ESSENCE', '0', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '0', NULL, '1');
...
INSERT INTO Buildings(BuildingType, Name, PrereqCivic, Cost, PrereqDistrict, Description, OuterDefenseHitPoints, Housing, Entertainment, TraitType, CitizenSlots, AdvisorType) VALUES
('SLTH_BUILDING_TEMPLE_OF_THE_HAND', 'LOC_SLTH_BUILDING_TEMPLE_OF_THE_HAND_NAME', 'CIVIC_MYSTICISM', '100', 'DISTRICT_HOLY_SITE', 'LOC_SLTH_BUILDING_TEMPLE_OF_THE_HAND_DESCRIPTION', '0', '0', '0', 'SLTH_TRAIT_CIVILIZATION_BUILDING_TEMPLE_OF_THE_HAND', '1', 'ADVISOR_CULTURE');
...
('PROJECT_STIR_FROM_SLUMBER', 'LOC_PROJECT_STIR_FROM_SLUMBER_NAME', 'LOC_PROJECT_STIR_FROM_SLUMBER_SHORT', 'LOC_PROJECT_STIR_FROM_SLUMBER_DESCRIPTION', '900', NULL, 'CIVIC_DIVINE_ESSENCE', '1', '1'),
('PROJECT_SAMHAIN', 'LOC_PROJECT_SAMHAIN_NAME', 'LOC_PROJECT_SAMHAIN_SHORT', 'LOC_PROJECT_SAMHAIN_DESCRIPTION', '250', NULL, NULL, '1', '1'),
('PROJECT_WHITE_HAND', 'LOC_PROJECT_WHITE_HAND_NAME', 'LOC_PROJECT_WHITE_HAND_SHORT', 'LOC_PROJECT_WHITE_HAND_DESCRIPTION', '400', NULL, 'CIVIC_POLITICAL_PHILOSOPHY','1', '0'),
('PROJECT_DEEPENING', 'LOC_PROJECT_DEEPENING_NAME', 'LOC_PROJECT_DEEPENING_SHORT', 'LOC_PROJECT_DEEPENING_DESCRIPTION', '600', NULL, 'CIVIC_PRIESTHOOD', '1', '0'),
('PROJECT_THE_DRAW', 'LOC_PROJECT_THE_DRAW_NAME', 'LOC_PROJECT_THE_DRAW_SHORT', 'LOC_PROJECT_THE_DRAW_DESCRIPTION', '900', 'TECH_STRENGTH_OF_WILL', NULL, '1', '0'),
('PROJECT_ASCENSION', 'LOC_PROJECT_ASCENSION_NAME', 'LOC_PROJECT_ASCENSION_SHORT', 'LOC_PROJECT_ASCENSION_DESCRIPTION', '1200', 'TECH_OMNISCIENCE', NULL, '1', '0');
...
('SLTH_TRAIT_CIVILIZATION_UNIT_DRIFA', 'KIND_TRAIT'),
('SLTH_TRAIT_CIVILIZATION_UNIT_AURIC_ASCENDED', 'KIND_TRAIT'),
