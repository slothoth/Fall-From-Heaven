...
VALUES	                      ('SLTH_CIVILIZATION_LUCHUIRP',	'TERRAIN_GRASS_HILLS',		    3	),
                              ('SLTH_CIVILIZATION_LUCHUIRP',	'TERRAIN_PLAINS_HILLS',		    5	),
                              ('SLTH_CIVILIZATION_LUCHUIRP',	'TERRAIN_DESERT_HILLS',		    2	);
...
VALUES	                   ('SLTH_CIVILIZATION_LUCHUIRP',	5);

INSERT INTO Leaders(LeaderType, Name, InheritFrom) VALUES
('LEADER_GARRIM', 'LOC_LEADER_GARRIM_NAME', 'LEADER_DEFAULT'),
('LEADER_BEERI', 'LOC_LEADER_BEERI_NAME', 'LEADER_DEFAULT');
INSERT INTO CivilizationLeaders(LeaderType, CivilizationType, CapitalName) VALUES
('LEADER_GARRIM', 'SLTH_CIVILIZATION_LUCHUIRP', 'LOC_CITY_LUCHUIRP_1_NAME'),
('LEADER_BEERI', 'SLTH_CIVILIZATION_LUCHUIRP', 'LOC_CITY_LUCHUIRP_1_NAME');
...
('SLTH_TRAIT_CIVILIZATION_LUCHUIRP_COOL', 'MODIFIER_BAN_SLTH_UNIT_SWORDSMAN'),
...
('SLTH_TRAIT_CIVILIZATION_LUCHUIRP_COOL', 'GRANT_DWARF_ABILITY_HILLS_DOUBLE_MOVE_CITY_ATTACH'),
...
-- TODO Fireball promo on Blasting, Adularia, Pallens
...
('MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING', 'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER');

INSERT INTO ModifierArguments(ModifierId, Name, Type, Value) VALUES
('MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING', 'YieldType', 'ARGTYPE_IDENTITY', 'YIELD_PRODUCTION'),
('MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING', 'Amount', 'ARGTYPE_IDENTITY', '3');

INSERT INTO BuildingModifiers(BuildingType, ModifierId) VALUES
('SLTH_BUILDING_BLASTING_WORKSHOP', 'MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING'),
('SLTH_BUILDING_PALLENS_ENGINE', 'MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING'),
('SLTH_BUILDING_ADULARIA_CHAMBER', 'MODIFIER_PROD_MINOR_GOLEM_PROMO_BUILDING');
...
INSERT INTO Units(UnitType, Name, BaseSightRange, BaseMoves, Combat, RangedCombat, Domain, FormationClass, Cost, BuildCharges, Description, TraitType, PromotionClass, PrereqTech, PrereqCivic, CanTrain, Maintenance, AdvisorType, EnabledByReligion, PseudoYieldType) VALUES
('SLTH_UNIT_WOOD_GOLEM', 'LOC_SLTH_UNIT_WOOD_GOLEM_NAME', '2', '1', '29', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '90', '0', 'LOC_SLTH_UNIT_WOOD_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_WOOD_GOLEM', NULL, 'TECH_CONSTRUCTION', NULL, '1', '1', 'ADVISOR_CONQUEST', '0', NULL),
('SLTH_UNIT_CLOCKWORK_GOLEM', 'LOC_SLTH_UNIT_CLOCKWORK_GOLEM_NAME', '2', '1', '72', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '360', '0', 'LOC_SLTH_UNIT_CLOCKWORK_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_CLOCKWORK_GOLEM', NULL, 'TECH_MACHINERY', NULL, '1', '1', 'ADVISOR_CONQUEST', '0', NULL),
('SLTH_UNIT_IRON_GOLEM', 'LOC_SLTH_UNIT_IRON_GOLEM_NAME', '2', '1', '48', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '180', '0', 'LOC_SLTH_UNIT_IRON_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_IRON_GOLEM', NULL, 'TECH_IRON_WORKING', NULL, '1', '1', 'ADVISOR_CONQUEST', '0', NULL),
('SLTH_UNIT_BONE_GOLEM', 'LOC_SLTH_UNIT_BONE_GOLEM_NAME', '2', '1', '63', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '360', '0', 'LOC_SLTH_UNIT_BONE_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_BONE_GOLEM', NULL, NULL, 'CIVIC_DIVINE_ESSENCE', '1', '1', 'ADVISOR_CONQUEST', '0', NULL),
('SLTH_UNIT_NULLSTONE_GOLEM', 'LOC_SLTH_UNIT_NULLSTONE_GOLEM_NAME', '2', '1', '63', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '0', 'LOC_SLTH_UNIT_NULLSTONE_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_NULLSTONE_GOLEM', NULL, 'TECH_MITHRIL_WEAPONS', NULL, '1', '1', 'ADVISOR_CONQUEST', '0', NULL),
('SLTH_UNIT_BARNAXUS', 'LOC_SLTH_UNIT_BARNAXUS_NAME', '2', '1', '24', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '180', '0', 'LOC_SLTH_UNIT_BARNAXUS_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_BARNAXUS', 'PROMOTION_CLASS_MELEE', 'TECH_CONSTRUCTION', NULL, '1', '1', 'ADVISOR_CONQUEST', '0', 'PSEUDOYIELD_UNIT_HERO'),
('SLTH_UNIT_MUD_GOLEM', 'LOC_SLTH_UNIT_MUD_GOLEM_NAME', '2', '2', '14', '1', 'DOMAIN_LAND', 'FORMATION_CLASS_CIVILIAN', '100', '5', 'LOC_SLTH_UNIT_MUD_GOLEM_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MUD_GOLEM', NULL, NULL, NULL, '1', '1', 'ADVISOR_GENERIC', '0', NULL);

INSERT INTO Unit_BuildingPrereqs(Unit, PrereqBuilding) VALUES
('SLTH_UNIT_WOOD_GOLEM', 'SLTH_BUILDING_SCULPTORS_STUDIO'),
('SLTH_UNIT_BARNAXUS', 'SLTH_BUILDING_SCULPTORS_STUDIO'),
...
('MODIFIER_BAN_SLTH_UNIT_SWORDSMAN', 'MODIFIER_PLAYER_UNIT_BUILD_DISABLED');

INSERT INTO ModifierArguments(ModifierId, Name, Type, Value) VALUES
('GOLEM_REDUCED_HEALING_ABILITY', 'Type', 'ARGTYPE_IDENTITY', 'ALL'),
('GOLEM_REDUCED_HEALING_ABILITY', 'Amount', 'ARGTYPE_IDENTITY', '-5'),
('MODIFIER_BAN_SLTH_UNIT_SWORDSMAN', 'UnitType', 'ARGTYPE_IDENTITY', 'SLTH_UNIT_SWORDSMAN');
...
('LEADER_GARRIM', 'KIND_LEADER'),
('LEADER_BEERI', 'KIND_LEADER'),
