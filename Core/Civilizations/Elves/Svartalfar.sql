...
('NULL_CIVILIZATION_SVARTALFAR', 'LOC_SLTH_BUILDING_DUMMY_NAME', 'LOC_NULL_DESCRIPTION'),
...
('SLTH_BUILDING_NULL_CIVILIZATION_SVARTALFAR_ALCHEMY_LAB', 'LOC_SLTH_BUILDING_DUMMY_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_SVARTALFAR', NULL, 'ADVISOR_RELIGIOUS'),
('SLTH_BUILDING_NULL_CIVILIZATION_SVARTALFAR_SIEGE_WORKSHOP', 'LOC_SLTH_BUILDING_DUMMY_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_SVARTALFAR', NULL, 'ADVISOR_RELIGIOUS');
