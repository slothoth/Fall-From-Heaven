...
('LEADER_AMELANCHIER', 'LOC_LEADER_AMELANCHIER_NAME', 'LEADER_DEFAULT'),
('LEADER_ARENDEL', 'LOC_LEADER_ARENDEL_NAME', 'LEADER_DEFAULT'),
('LEADER_THESSA', 'LOC_LEADER_THESSA_NAME', 'LEADER_DEFAULT');

INSERT INTO	StartBiasTerrains (CivilizationType,			TerrainType,			        Tier	)
VALUES	                      ('SLTH_CIVILIZATION_LJOSALFAR',	'TERRAIN_GRASS',		    3	),
                              ('SLTH_CIVILIZATION_LJOSALFAR',	'TERRAIN_GRASS_HILLS',		3	),
                              ('SLTH_CIVILIZATION_LJOSALFAR',	'TERRAIN_PLAINS',		        3	),
                              ('SLTH_CIVILIZATION_LJOSALFAR',	'TERRAIN_PLAINS_HILLS',		3	);
...
('LEADER_THESSA', 'SLTH_CIVILIZATION_LJOSALFAR', 'LOC_CITY_LJOSALFAR_1_NAME');
...
('SLTH_CIVILIZATION_LJOSALFAR', 'NULL_CIVILIZATION_LJOSALFAR');

INSERT INTO Traits(TraitType, Name, Description) VALUES
('NULL_CIVILIZATION_LJOSALFAR', 'LOC_SLTH_BUILDING_DUMMY_NAME', 'LOC_NULL_DESCRIPTION'),
...
('SLTH_TRAIT_CIVILIZATION_LJOSALFAR_COOL', 'MODIFIER_GRANT_TECH_SKIP_'),
('SLTH_TRAIT_CIVILIZATION_LJOSALFAR_COOL', 'TRAIT_GRANT_ELF_ABILITY_FEATUREATTACKS_CITY_ATTACH'),
('SLTH_TRAIT_CIVILIZATION_LJOSALFAR_COOL', 'TRAIT_GRANT_ELF_ABILITY_FEATUREDOUBLEMOVES_CITY_ATTACH'),
...
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_ALCHEMY_LAB'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_SIEGE_WORKSHOP');
...
('SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_ALCHEMY_LAB', 'LOC_SLTH_BUILDING_BANNED_ALCHEMY_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_LJOSALFAR', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_SIEGE_WORKSHOP', 'LOC_SLTH_BUILDING_BANNED_SIEGE_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_LJOSALFAR', NULL, 'ADVISOR_RELIGIOUS', '1');
...
('SLTH_UNIT_GILDEN', 'LOC_SLTH_UNIT_GILDEN_NAME', '2', '1', '24', '29', '2', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '120', '0', 'LOC_SLTH_UNIT_GILDEN_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_GILDEN', '0', 'PROMOTION_CLASS_RANGED', 'SLTH_TECH_ARCHERY', NULL, '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_FYRDWELL', 'LOC_SLTH_UNIT_FYRDWELL_NAME', '2', '3', '29', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '120', '0', 'LOC_SLTH_UNIT_FYRDWELL_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_FYRDWELL', '0', 'PROMOTION_CLASS_LIGHT_CAVALRY', 'TECH_STIRRUPS', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_FLURRY', 'LOC_SLTH_UNIT_FLURRY_NAME', '2', '2', '58', '63', '2', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '0', 'LOC_SLTH_UNIT_FLURRY_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_FLURRY', '0', 'PROMOTION_CLASS_RANGED', 'TECH_MACHINERY', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0');
...
('LEADER_AMELANCHIER', 'KIND_LEADER'),
('LEADER_ARENDEL', 'KIND_LEADER'),
('LEADER_THESSA', 'KIND_LEADER'),
