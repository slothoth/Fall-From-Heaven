...
('NULL_CIVILIZATION_LJOSALFAR', 'LOC_SLTH_BUILDING_LJOSALFAR_BAN_NULL_NAME', 'LOC_NULL_DESCRIPTION'),
...
('SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_ALCHEMY_LAB', 'LOC_SLTH_BUILDING_LJOSALFAR_BAN_NULL_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_LJOSALFAR', NULL, 'ADVISOR_RELIGIOUS'),
('SLTH_BUILDING_NULL_CIVILIZATION_LJOSALFAR_SIEGE_WORKSHOP', 'LOC_SLTH_BUILDING_LJOSALFAR_BAN_NULL_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_LJOSALFAR', NULL, 'ADVISOR_RELIGIOUS');
