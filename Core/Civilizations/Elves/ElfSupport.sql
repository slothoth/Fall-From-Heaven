...
('GRANT_ELF_ABILITY_FEATUREDOUBLEMOVES_CITY', 'AbilityType', 'ARGTYPE_IDENTITY', 'ELF_RACIAL_MOVEMENT_ON_FOREST'),
('TRAIT_GRANT_ELF_ABILITY_FEATUREATTACKS_CITY_ATTACH', 'ModifierId', 'ARGTYPE_IDENTITY', 'GRANT_ELF_ABILITY_FEATUREATTACKS_CITY'),
('GRANT_ELF_ABILITY_FEATUREATTACKS_CITY', 'AbilityType', 'ARGTYPE_IDENTITY', 'ELF_RACIAL_STRENGTH_ON_FOREST');
