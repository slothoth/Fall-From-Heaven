...
('SLTH_CIVILIZATION_CALABIM', 'NULL_CIVILIZATION_CALABIM');
...
('NULL_CIVILIZATION_CALABIM', 'LOC_SLTH_BUILDING_CALABIM_BAN_NULL_NAME', 'LOC_NULL_DESCRIPTION'),
...
('BUILDING_ORDU', 'LOC_BUILDING_BREEDING_PIT_NAME', NULL, NULL, '120', 'DISTRICT_CITY_CENTER', 'LOC_BUILDING_BREEDING_PIT_DESCRIPTION', '0', '-1', '0', 'SLTH_TRAIT_CIVILIZATION_BUILDING_BREEDING_PIT', NULL, 'ADVISOR_GENERIC'),
...
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_CALABIM_ALCHEMY_LAB'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_CALABIM_ELDER_COUNCIL'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_SHEAIM_TRAINING_YARD');
...
('BUILDING_ORDU', 'BREEDING_PIT_GROWTH_RATE');
...
('SLTH_UNIT_LOSHA', 'LOC_SLTH_UNIT_LOSHA_NAME', '2', '1', '34', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '300', '0', 'LOC_SLTH_UNIT_LOSHA_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_LOSHA', '0', 'PROMOTION_CLASS_MELEE', NULL, 'CIVIC_FANATICISM', '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_HERO', '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_MOROI', 'LOC_SLTH_UNIT_MOROI_NAME', '2', '1', '19', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '60', '0', 'LOC_SLTH_UNIT_MOROI_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MOROI', '0', 'PROMOTION_CLASS_MELEE', 'TECH_BRONZE_WORKING', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_BRUJAH', 'LOC_SLTH_UNIT_BRUJAH_NAME', '2', '1', '53', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '0', 'LOC_SLTH_UNIT_BRUJAH_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_BRUJAH', '0', 'PROMOTION_CLASS_MELEE', NULL, 'CIVIC_RAGE', '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_VAMPIRE', 'LOC_SLTH_UNIT_VAMPIRE_NAME', '2', '1', '24', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '180', '0', 'LOC_SLTH_UNIT_VAMPIRE_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_VAMPIRE', '0', 'PROMOTION_CLASS_MELEE', NULL, 'CIVIC_FEUDALISM', '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0');
...
('VAMPIRISM_INHERENT',  'LOC_NULL_NAME', 'LOC_NULL_DESCRIPTION','0', '1'),
...
('CLASS_SLTH_VAMPIRE', 'ABILITY_CLASS'),
...
('SLTH_UNIT_LOSHA', 'CLASS_SLTH_VAMPIRE'),
('SLTH_UNIT_VAMPIRE', 'CLASS_SLTH_VAMPIRE'),
('SLTH_UNIT_VAMPIRE_LORD', 'CLASS_SLTH_VAMPIRE'),
('VAMPIRISM_INHERENT', 'CLASS_SLTH_VAMPIRE'),
