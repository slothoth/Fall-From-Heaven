...
VALUES	                   ('SLTH_CIVILIZATION_ELOHIM',	5);
...
('SLTH_CIVILIZATION_ELOHIM', 'LOC_CIV_ELOHIM_NAME', 'LOC_CIV_ELOHIM_DESCRIPTION', 'LOC_SLTH_CIV_ELOHIM_ADJECTIVE', '10', 'CIVILIZATION_LEVEL_FULL_CIV', 'ETHNICITY_ASIAN');
INSERT INTO Leaders(LeaderType, Name, InheritFrom) VALUES
('LEADER_ETHNE', 'LOC_LEADER_ETHNE_NAME', 'LEADER_DEFAULT'),
('LEADER_EINION', 'LOC_LEADER_EINION_NAME', 'LEADER_DEFAULT');
INSERT INTO CivilizationLeaders(LeaderType, CivilizationType, CapitalName) VALUES
('LEADER_ETHNE', 'SLTH_CIVILIZATION_ELOHIM', 'LOC_CITY_ELOHIM_1_NAME'),
('LEADER_EINION', 'SLTH_CIVILIZATION_ELOHIM', 'LOC_CITY_ELOHIM_1_NAME');
...
('SLTH_TRAIT_CIVILIZATION_ELOHIM_COOL', 'ALLOW_HALLOWING');
...
('SLTH_BUILDING_CHANCEL', 'LOC_SLTH_BUILDING_CHANCEL_NAME', NULL, 'CIVIC_PRIESTHOOD', '120', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_CHANCEL_DESCRIPTION', '200', '0', '0', 'SLTH_TRAIT_CIVILIZATION_BUILDING_CHANCEL_OF_GUARDIANS', NULL, 'ADVISOR_GENERIC');
...
('SLTH_UNIT_DEVOUT', 'LOC_SLTH_UNIT_DEVOUT_NAME', '2', '2', '24', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '120', '0', 'LOC_SLTH_UNIT_DEVOUT_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_DEVOUT', '0', 'PROMOTION_CLASS_RECON', 'TECH_POISONS', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_MONK', 'LOC_SLTH_UNIT_MONK_NAME', '2', '2', '29', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '120', '0', 'LOC_SLTH_UNIT_MONK_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_MONK', '0', 'PROMOTION_CLASS_DISCIPLE', NULL, 'CIVIC_PRIESTHOOD', '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_RELIGIOUS', '0'),
('SLTH_UNIT_CORLINDALE', 'LOC_SLTH_UNIT_CORLINDALE_NAME', '2', '2', '0', '0', '2', 'DOMAIN_LAND', 'FORMATION_CLASS_CIVILIAN', '300', '1', 'LOC_SLTH_UNIT_CORLINDALE_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_CORLINDALE', '0', 'PROMOTION_CLASS_ADEPT', NULL, 'CIVIC_FANATICISM', '1', '1', '0', '0', '0', 'PSEUDOYIELD_UNIT_MAGIC', '0', 'ADVISOR_CONQUEST', '0');
...
('PROJECT_HALLOWING_OF_ELOHIM', 'LOC_PROJECT_HALLOWING_OF_ELOHIM_NAME', 'LOC_PROJECT_HALLOWING_OF_ELOHIM_SHORT', 'LOC_PROJECT_HALLOWING_OF_ELOHIM_DESCRIPTION', '600', NULL, 'CIVIC_WAY_OF_THE_WISE', '1');

INSERT INTO Modifiers(ModifierId, ModifierType) VALUES ('ALLOW_HALLOWING', 'MODIFIER_PLAYER_ALLOW_PROJECT_CHINA');

INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES ('ALLOW_HALLOWING', 'ProjectType', 'PROJECT_HALLOWING_OF_ELOHIM');

INSERT INTO Types(Type, Kind) VALUES
('SLTH_CIVILIZATION_ELOHIM', 'KIND_CIVILIZATION'),
('LEADER_ETHNE', 'KIND_LEADER'),
('LEADER_EINION', 'KIND_LEADER'),
...
('PROJECT_HALLOWING_OF_ELOHIM', 'KIND_PROJECT');