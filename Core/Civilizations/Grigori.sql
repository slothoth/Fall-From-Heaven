...
('LEADER_CASSIEL', 'LOC_LEADER_CASSIEL_NAME', 'LEADER_DEFAULT');
INSERT INTO CivilizationLeaders(LeaderType, CivilizationType, CapitalName) VALUES
('LEADER_CASSIEL', 'SLTH_CIVILIZATION_GRIGORI', 'LOC_CITY_GRIGORI_1_NAME');
...
('SLTH_CIVILIZATION_GRIGORI', 'NULL_CIVILIZATION_GRIGORI');

INSERT INTO Traits(TraitType, Name, Description) VALUES
('NULL_CIVILIZATION_GRIGORI', 'LOC_SLTH_GRIGORI_BUILDING_NULL_NAME', 'LOC_NULL_DESCRIPTION'),
...
('BUILDING_GUILDHALL', 'LOC_SLTH_BUILDING_ADVENTURERS_GUILD_NAME', NULL, 'CIVIC_CURRENCY', '120', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_ADVENTURERS_GUILD_DESCRIPTION', '0', '0', '0', 'SLTH_TRAIT_CIVILIZATION_BUILDING_ADVENTURERS_GUILD', NULL, 'ADVISOR_CONQUEST', '0'),
('SLTH_BUILDING_TAVERN_GRIGORI', 'LOC_SLTH_BUILDING_TAVERN_GRIGORI_NAME', NULL, 'CIVIC_MERCANTILISM', '250', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_TAVERN_GRIGORI_DESCRIPTION', '0', '0', '0', 'SLTH_TRAIT_CIVILIZATION_BUILDING_TAVERN_GRIGORI', NULL, 'ADVISOR_GENERIC', '0'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_PAGAN_TEMPLE', 'LOC_SLTH_BUILDING_BANNED_PAGAN_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_KILMORPH', 'LOC_SLTH_BUILDING_BANNED_KILMORPH_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_LEAVES', 'LOC_SLTH_BUILDING_BANNED_LEAVES_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_EMPYREAN', 'LOC_SLTH_BUILDING_BANNED_EMPYREAN_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_ORDER', 'LOC_SLTH_BUILDING_BANNED_ORDER_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_OVERLORDS', 'LOC_SLTH_BUILDING_BANNED_OVERLORDS_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1'),
('SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_VEIL', 'LOC_SLTH_BUILDING_BANNED_VEIL_NAME', NULL, NULL, '500', 'DISTRICT_CITY_CENTER', 'LOC_SLTH_BUILDING_NULLDESCRIPTION', '0', '0', '0', 'NULL_CIVILIZATION_GRIGORI', NULL, 'ADVISOR_RELIGIOUS', '1');
...
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_PAGAN_TEMPLE'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_KILMORPH'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_LEAVES'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_EMPYREAN'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_ORDER'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_OVERLORDS'),
('BUILDINGS','SLTH_BUILDING_NULL_CIVILIZATION_GRIGORI_TEMPLE_OF_THE_VEIL');
...
('GRANT_EXPERIENCE_SMALL_ABILITY_ADVENT_GUILD', 'LOC_NULL_NAME', 'LOC_NULL_DESCRIPTION', '1', '1');
...
('SLTH_UNIT_DRAGON_SLAYER', 'LOC_SLTH_UNIT_DRAGON_SLAYER_NAME', '2', '1', '29', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '120', '0', 'LOC_SLTH_UNIT_DRAGON_SLAYER_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_DRAGON_SLAYER', '0', 'PROMOTION_CLASS_MELEE', 'TECH_IRON_WORKING', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
('SLTH_UNIT_LUONNOTAR', 'LOC_SLTH_UNIT_LUONNOTAR_NAME', '2', '1', '48', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '240', '0', 'LOC_SLTH_UNIT_LUONNOTAR_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_LUONNOTAR', '0', 'PROMOTION_CLASS_DISCIPLE', 'TECH_STRENGTH_OF_WILL', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_RELIGIOUS', '0'),
('SLTH_UNIT_GRIGORI_MEDIC', 'LOC_SLTH_UNIT_GRIGORI_MEDIC_NAME', '2', '1', '19', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '180', '0', 'LOC_SLTH_UNIT_GRIGORI_MEDIC_DESCRIPTION', 'SLTH_TRAIT_CIVILIZATION_UNIT_GRIGORI_MEDIC', '0', 'PROMOTION_CLASS_MELEE', 'TECH_MEDICINE', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0');
