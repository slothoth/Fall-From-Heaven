...
('SLTH_LEADER_DECIUS_BANNOR', 'LOC_SLTH_LEADER_DECIUS_NAME', 'LEADER_DEFAULT');
...
('SLTH_LEADER_DECIUS_BANNOR', 'SLTH_CIVILIZATION_BANNOR', 'LOC_CITY_BANNOR_1_NAME');
...
('SLTH_UNIT_DEMAGOG', 'LOC_SLTH_UNIT_DEMAGOG_NAME', '2', '1', '24', '0', '0', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', '60', '0', 'LOC_SLTH_UNIT_DEMAGOG_DESCRIPTION', 'TRAIT_UNREACHABLE', '1', 'PROMOTION_CLASS_MELEE', 'TECH_IRON_WORKING', NULL, '1', '1', '0', '0', '0', NULL, '0', 'ADVISOR_CONQUEST', '0'),
...
('UNLOCK_FROM_POLICY_CRUSADE', 'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD');
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
('UNLOCK_FROM_POLICY_CRUSADE', 'UnitType', 'SLTH_UNIT_DEMAGOG');
INSERT INTO PolicyModifiers(PolicyType, ModifierId) VALUES
('SLTH_POLICY_CRUSADE', 'UNLOCK_FROM_POLICY_CRUSADE');

INSERT INTO Types(Type, Kind) VALUES
('SLTH_CIVILIZATION_BANNOR', 'KIND_CIVILIZATION'),
('SLTH_LEADER_SABATHIEL', 'KIND_LEADER'),
('SLTH_LEADER_CAPRIA', 'KIND_LEADER'),
('SLTH_LEADER_DECIUS_BANNOR', 'KIND_LEADER'),
