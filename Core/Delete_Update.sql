...
DELETE FROM Projects WHERE ProjectType NOT IN ('PROJECT_ENHANCE_DISTRICT_COMMERCIAL_HUB','PROJECT_ENHANCE_DISTRICT_CAMPUS', 'PROJECT_ENHANCE_DISTRICT_THEATER');
...
DELETE FROM Districts WHERE DistrictType NOT IN ('DISTRICT_CITY_CENTER', 'DISTRICT_HOLY_SITE', 'DISTRICT_CAMPUS', 'DISTRICT_COMMERCIAL_HUB', 'DISTRICT_THEATER', 'DISTRICT_INDUSTRIAL_ZONE', 'DISTRICT_HARBOR', 'DISTRICT_WONDER');
DELETE FROM District_Adjacencies;
DELETE FROM District_GreatPersonPoints;
DELETE FROM Project_GreatPersonPoints;

UPDATE Project_YieldConversions SET PercentOfProductionRate= 50 WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_THEATER';
UPDATE Project_YieldConversions SET PercentOfProductionRate= 50 WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_CAMPUS';
UPDATE Project_YieldConversions SET PercentOfProductionRate= 50 WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_COMMERCIAL_HUB';
UPDATE Projects SET PrereqDistrict = NULL;
UPDATE Projects SET PrereqTech='TECH_WRITING' WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_CAMPUS';
UPDATE Projects SET PrereqCivic='CIVIC_DRAMA_POETRY' WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_THEATER';
UPDATE Projects SET PrereqTech='TECH_MATHEMATICS' WHERE ProjectType='PROJECT_ENHANCE_DISTRICT_COMMERCIAL_HUB';
