UPDATE Districts SET PrereqCivic = 'SLTH_CIVIC_MYSTICISM' WHERE DistrictType = 'DISTRICT_HOLY_SITE';
UPDATE Districts SET PrereqCivic = 'SLTH_CIVIC_MYSTICISM' WHERE DistrictType = 'DISTRICT_CAMPUS';
UPDATE Districts SET PrereqTech = 'SLTH_TECH_BRONZE_WORKING' WHERE DistrictType = 'DISTRICT_ENCAMPMENT';
UPDATE Districts SET PrereqTech = 'SLTH_TECH_FISHING' WHERE DistrictType = 'DISTRICT_HARBOR';
UPDATE Districts SET PrereqCivic = 'SLTH_CIVIC_FESTIVALS' WHERE DistrictType = 'DISTRICT_COMMERCIAL_HUB';
UPDATE Districts SET PrereqCivic = 'SLTH_CIVIC_FESTIVALS' WHERE DistrictType = 'DISTRICT_ENTERTAINMENT_COMPLEX';
UPDATE Districts SET PrereqCivic = 'SLTH_CIVIC_FESTIVALS' WHERE DistrictType = 'DISTRICT_THEATER';
UPDATE Districts SET PrereqTech = 'SLTH_TECH_SMELTING' WHERE DistrictType = 'DISTRICT_INDUSTRIAL_ZONE';
UPDATE Districts SET PrereqTech = 'SLTH_TECH_SANITATION' WHERE DistrictType = 'DISTRICT_AQUEDUCT';
...
UPDATE MajorStartingUnits SET Unit = 'SLTH_UNIT_WARRIOR' WHERE Unit = 'UNIT_WARRIOR';
...
DELETE FROM Units WHERE UnitType NOT IN ('UNIT_GREAT_GENERAL', 'UNIT_GREAT_ADMIRAL', 'UNIT_GREAT_ENGINEER', 'UNIT_GREAT_MERCHANT', 'UNIT_GREAT_PROPHET', 'UNIT_GREAT_SCIENTIST', 'UNIT_GREAT_WRITER', 'UNIT_GREAT_ARTIST', 'UNIT_GREAT_MUSICIAN', 'UNIT_BUILDER', 'UNIT_TRADER', 'UNIT_SETTLER');
