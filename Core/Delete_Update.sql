...
DELETE FROM Projects WHERE ProjectType NOT IN ('PROJECT_ENHANCE_DISTRICT_ENCAMPMENT', 'PROJECT_ENHANCE_DISTRICT_HARBOR', 'PROJECT_ENHANCE_DISTRICT_INDUSTRIAL_ZONE', 'PROJECT_ENHANCE_DISTRICT_COMMERCIAL_HUB', 'PROJECT_ENHANCE_DISTRICT_HOLY_SITE', 'PROJECT_ENHANCE_DISTRICT_CAMPUS', 'PROJECT_ENHANCE_DISTRICT_THEATER', 'PROJECT_BREAD_AND_CIRCUSES');
