...
('TRIBE_CONDITION_SET_SCORPION_CLAN_OPEN_GRASS', 'TERRAIN_GRASS_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SCORPION_CLAN_OPEN_PLAINS', 'TERRAIN_PLAINS_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SCORPION_CLAN_OPEN_TUNDRA', 'TERRAIN_TUNDRA_HILLS', NULL, NULL, '1', '0'),
...
INSERT INTO BarbarianTribe_MapConditions(MapConditionSetType, TerrainType, FeatureType, ResourceType, Range, Invert) VALUES
('TRIBE_CONDITION_SET_SKELETON_OPEN_DESERT', 'TERRAIN_DESERT_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_DESERT_HILLS', 'TERRAIN_DESERT_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_OPEN_SNOW', 'TERRAIN_SNOW_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_SNOW_HILLS', 'TERRAIN_SNOW_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_OPEN_GRASS', 'TERRAIN_GRASS_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_OPEN_PLAINS', 'TERRAIN_PLAINS_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_SKELETON_OPEN_TUNDRA', 'TERRAIN_TUNDRA_HILLS', NULL, NULL, '1', '0'),
...
INSERT INTO TypeTags(Type, Tag) VALUES
('SLTH_UNIT_HUNTER', 'CLASS_LIZARDMEN');
...
('TRIBE_CONDITION_SET_LIZARDMAN_OPEN_GRASS', 'TERRAIN_GRASS_HILLS', NULL, NULL, '1', '0'),
('TRIBE_CONDITION_SET_LIZARDMAN_OPEN_PLAINS', 'TERRAIN_PLAINS_HILLS', NULL, NULL, '1', '0'),
