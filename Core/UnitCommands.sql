...
CREATE TABLE IF NOT EXISTS CustomOperations(OperationType text primary key, Callback text, SimpleText text, PromotionPrereq text,
                                            UnitPrereq text, ActivationPrereq text, simpleAmount integer default 0, SecondAmount integer default 0,
...
('UNITOPERATION_FEED_ON_CITY', 'SlthOnBespokeSpell', NULL, NULL, 'SLTH_UNIT_VAMPIRE', 'OnCityPopTwoPlus'),                  -- port to ability
