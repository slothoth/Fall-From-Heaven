...
('ABILITY_UNHOLY_TAINT', 'LOC_ABILITY_UNHOLY_TAINT_NAME', 'LOC_ABILITY_UNHOLY_TAINT_DESCRIPTION', '1', '1');            -- todo unattached
...
('ABILITY_AERONS_CHOSEN', 'MODIFIER_PROMOTION_AERONS_CHOSEN'),
...
-- ABILITY
-- AERONS_CHOSEN +2 UNHOLY
-- BLESSED +1 HOLY
-- FLAMING ARROWS +1 FIRE
-- ABILITY FROSTLING +1 COLD
-- POISONED BLADE +1 POISON
-- SHEUT STONE +1 DEATH
-- UNHOLY_TAINT +1 UNHOLY
