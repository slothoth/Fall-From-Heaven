...
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
('REQUIREMENT_MARY_ATTACKING', 'Tag', 'CLASS_ZOMBIE'),
('REQUIREMENT_MARY_DEFENDING', 'Tag', 'CLASS_ZOMBIE');
...
VALUES	('MODIFIER_ALL_COMBAT_RESULTS_APPLY_MODIFIER_TO_UNITS_ON_TILE',				'KIND_MODIFIER'),
		...
		('MODIFIER_ALL_PLAYER_IMPROVEMENTS_GRANT_ADJACENT_YIELDS',					'KIND_MODIFIER'),
...
VALUES	('MODIFIER_ALL_COMBAT_RESULTS_APPLY_MODIFIER_TO_UNITS_ON_TILE',				'COLLECTION_COMBAT_RESULTS',		'EFFECT_ATTACH_PERMANENT_MODIFIER_TO_PLOT_UNITS'),
		('MODIFIER_ALL_COMBAT_RESULTS_APPLY_MODIFIER_TO_UNITS_ON_ADJACENT_TILES',	'COLLECTION_COMBAT_RESULTS',		'EFFECT_ATTACH_PERMANENT_MODIFIER_TO_ADJACENT_PLOT_UNITS'),
		('MODIFIER_ALL_UNITS_ADJUST_PROPERTY',										'COLLECTION_ALL_UNITS',				'EFFECT_ADJUST_UNIT_PROPERTY'),
		('MODIFIER_ALL_PLAYER_IMPROVEMENTS_GRANT_ADJACENT_YIELDS',					'COLLECTION_PLAYER_IMPROVEMENTS',	'EFFECT_GRANT_IMPROVEMENT_ADJACENT_YIELDS'),
		('MODIFIER_ALL_PLAYER_IMPROVEMENTS_ADJUST_PROPERTY',						'COLLECTION_PLAYER_IMPROVEMENTS',	'EFFECT_ADJUST_IMPROVEMENT_PROPERTY');

INSERT OR IGNORE  INTO GameModifiers
		(ModifierId)
VALUES	-- ('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT_ADJACENT'),
		('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT');

INSERT OR IGNORE  INTO Modifiers
		(ModifierId,																	ModifierType,																SubjectRequirementSetId,							RunOnce,	Permanent)
VALUES	('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT_ADJACENT',			'MODIFIER_ALL_COMBAT_RESULTS_APPLY_MODIFIER_TO_UNITS_ON_ADJACENT_TILES',	NULL,				0,			0),
		('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT',					'MODIFIER_ALL_COMBAT_RESULTS_APPLY_MODIFIER_TO_UNITS_ON_TILE',				'MARY_INVOLVED_IN_COMBAT_REQS',				0,			0);

INSERT OR IGNORE  INTO ModifierArguments
		(ModifierId,																	Name,				Value)
VALUES	('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT_ADJACENT',			'ModifierId',		'MODIFIER_PLAGUE_CARRIER_GRANT'),
		('DEMONIC_SECT_HEAVENLY_DEMON_COMBAT_STRENGTH_ON_DEAD_UNIT',					'ModifierId',		'MODIFIER_PLAGUE_CARRIER_GRANT');
...
VALUES	('THIS_COMBAT_RESULTS_IN_UNIT_DEATH',										'REQUIREMENTSET_TEST_ANY');

INSERT OR IGNORE INTO RequirementSetRequirements
		(RequirementSetId,								RequirementId)
VALUES	('THIS_COMBAT_RESULTS_IN_UNIT_DEATH',										'REQUIRE_THIS_COMBAT_RESULTS_IN_UNIT_DEATH'),
		('THIS_COMBAT_RESULTS_IN_UNIT_DEATH',									'REQUIRE_THIS_COMBAT_RESULTS_IN_BARB_UNIT_DEATH');

INSERT OR IGNORE  INTO Requirements
		(RequirementId, 									RequirementType,								Inverse)
VALUES	('REQUIRE_THIS_COMBAT_RESULTS_IN_UNIT_DEATH',		'REQUIREMENT_COMBAT_RESULTS_UNIT_DIED',			0),
		('REQUIRE_THIS_COMBAT_RESULTS_IN_BARB_UNIT_DEATH',	'REQUIREMENT_COMBAT_RESULTS_UNIT_DIED',			0);

INSERT OR IGNORE  INTO RequirementArguments
		(RequirementId, 									Name,				Value)
VALUES	('REQUIRE_THIS_COMBAT_RESULTS_IN_UNIT_DEATH',		'ExcludeBarbs',		1),
		('REQUIRE_THIS_COMBAT_RESULTS_IN_BARB_UNIT_DEATH',	'OnlyBarbs',		1);
