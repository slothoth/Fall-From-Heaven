...
('SLTH_POLICY_RELIGION', 'MODIFIER_SLTH_POLICY_RELIGION_BUILDING_PAGAN_TEMPLE_ADD_AMENITIES'),
...
('SLTH_POLICY_CRUSADE', 'CRUSADE_ALLOW_DEMAGOG'),
...
('SLTH_POLICY_SLAVERY', 'MODIFIER_SLTH_POLICY_SLAVERY_CAPTURE_ATTACH'),
...
('SLTH_POLICY_FOREIGN_TRADE', 'MODIFIER_SLTH_POLICY_FOREIGN_TRADE_ADJUST_TRADE_ROUTE_CAPACITY_ATTACH'),
...
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_KILMORPH_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_KILMORPH'),       -- these arent working...
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_LEAVES_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_LEAVES'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_ORDER_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_ORDER'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_OVERLORDS_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_OVERLORDS'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_VEIL_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_VEIL'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_EMPYREAN_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_EMPYREAN'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_PAGAN_TEMPLE_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'REQUIREMENTS_CITY_HAS_SHRINE'),
...
('MODIFIER_SLTH_POLICY_NATIONHOOD_BUILDING_TRAINING_YARD_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TRAINING_YARD'),
...
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_COURTHOUSE_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_COURTHOUSE'),
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_BASILICA_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_BASILICA'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_ADD_GOLDYIELD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', '0', NULL),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_MARKET_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_MARKET'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_TAVERN_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_TAVERN'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_THEATRE_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_THEATRE'),
...
('MODIFIER_SLTH_POLICY_SCHOLARSHIP_BUILDING_LIBRARY_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_LIBRARY'),
...
('SLTH_SLAVERY_CAPTURE', 'MODIFIER_UNIT_ADJUST_COMBAT_UNIT_CAPTURE', '0', NULL),
('MODIFIER_SLTH_POLICY_SLAVERY_CAPTURE_ATTACH', 'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER', '0', NULL),
...
('MODIFIER_SLTH_POLICY_MERCANTILISM_BUILDING_MARKET_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_MARKET'),
...
('MODIFIER_SLTH_POLICY_FOREIGN_TRADE_ADJUST_TRADE_ROUTE_CAPACITY_ATTACH', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', '0', NULL),
...
('MODIFIER_SLTH_POLICY_GUARDIAN_OF_NATURE_BUILDING_GROVE_ADD_AMENITIES', 'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY', '0', 'SLTH_REQUIRES_CITY_HAS_GROVE');
...
('MODIFIER_FARM_GOLD_BONUS', 'YieldType', 'ARGTYPE_IDENTITY', 'YIELD_FAITH'),
...
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_KILMORPH_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_LEAVES_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_ORDER_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_OVERLORDS_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_VEIL_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_EMPYREAN_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_PAGAN_TEMPLE_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('MODIFIER_SLTH_POLICY_NATIONHOOD_BUILDING_TRAINING_YARD_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_COURTHOUSE_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_BASILICA_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_MARKET_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_TAVERN_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_THEATRE_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('MODIFIER_SLTH_POLICY_SCHOLARSHIP_BUILDING_LIBRARY_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('SLTH_SLAVERY_CAPTURE', 'CanCapture', 'ARGTYPE_IDENTITY', '1'),
('SLTH_SLAVERY_CAPTURE', 'UnitType', 'ARGTYPE_IDENTITY', 'SLTH_UNIT_SLAVE'),
('MODIFIER_SLTH_POLICY_SLAVERY_CAPTURE_ATTACH', 'ModifierId', 'ARGTYPE_IDENTITY', 'SLTH_SLAVERY_CAPTURE'),
...
('MODIFIER_SLTH_POLICY_MERCANTILISM_BUILDING_MARKET_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '1'),
...
('MODIFIER_SLTH_POLICY_FOREIGN_TRADE_ADJUST_TRADE_ROUTE_CAPACITY_ATTACH', 'ModifierId', 'ARGTYPE_IDENTITY', 'MODIFIER_SLTH_POLICY_FOREIGN_TRADE_ADJUST_TRADE_ROUTE_CAPACITY'),
...
('MODIFIER_SLTH_POLICY_GUARDIAN_OF_NATURE_BUILDING_GROVE_ADD_AMENITIES', 'Amount', 'ARGTYPE_IDENTITY', '2');
...
('SLTH_REQUIRES_CITY_HAS_TRAINING_YARD', 'BuildingType', 'ARGTYPE_IDENTITY', 'BUILDING_BARRACKS'),
('SLTH_REQUIRES_CITY_HAS_COURTHOUSE', 'BuildingType', 'ARGTYPE_IDENTITY', 'BUILDING_QUEENS_BIBLIOTHEQUE'),
('SLTH_REQUIRES_CITY_HAS_BASILICA', 'BuildingType', 'ARGTYPE_IDENTITY', 'BUILDING_SYNAGOGUE'),
('SLTH_REQUIRES_CITY_HAS_MARKET', 'BuildingType', 'ARGTYPE_IDENTITY', 'BUILDING_MARKET'),
('SLTH_REQUIRES_CITY_HAS_TAVERN', 'BuildingType', 'ARGTYPE_IDENTITY', 'SLTH_BUILDING_TAVERN'),
('SLTH_REQUIRES_CITY_HAS_THEATRE', 'BuildingType', 'ARGTYPE_IDENTITY', 'BUILDING_AMPHITHEATER'),
...
('CRUSADE_ALLOW_DEMAGOG', 'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD');

INSERT INTO Modifiers(ModifierId, ModifierType, SubjectRequirementSetId) VALUES
('STATE_VEIL_ALLOW_MESHABBER', 'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD', 'PLAYER_HAS_VEIL_HOLY_CITY_REQS'),        -- holy city required.
('STATE_KILMORPH_ALLOW_MITHRIL_GOLEM', 'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD', 'PLAYER_HAS_KILMORPH_HOLY_CITY_REQS');

INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
('PLAYER_HAS_VEIL_HOLY_CITY_REQS', 'REQUIREMENTSET_TEST_ALL'),
('PLAYER_HAS_KILMORPH_HOLY_CITY_REQS', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
('PLAYER_HAS_VEIL_HOLY_CITY_REQS', 'REQUIREMENT_CHECK_PLAYER_HAS_VEIL_HOLY_CITY'),
('PLAYER_HAS_KILMORPH_HOLY_CITY_REQS', 'REQUIREMENT_CHECK_PLAYER_HAS_KILMORPH_HOLY_CITY');

INSERT INTO Requirements(RequirementId, RequirementType) VALUES
('REQUIREMENT_CHECK_PLAYER_HAS_VEIL_HOLY_CITY', 'REQUIREMENT_COLLECTION_ANY_MET'),
('REQUIREMENT_CHECK_PLAYER_HAS_KILMORPH_HOLY_CITY', 'REQUIREMENT_COLLECTION_ANY_MET');

INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
('REQUIREMENT_CHECK_PLAYER_HAS_VEIL_HOLY_CITY', 'CollectionType',  'COLLECTION_PLAYER_CITIES'),
('REQUIREMENT_CHECK_PLAYER_HAS_VEIL_HOLY_CITY', 'RequirementSetId',  'PLAYER_HAS_VEIL_HOLY_CITY_SUBREQS'),
('REQUIREMENT_CHECK_PLAYER_HAS_KILMORPH_HOLY_CITY', 'CollectionType',  'COLLECTION_PLAYER_CITIES'),
('REQUIREMENT_CHECK_PLAYER_HAS_KILMORPH_HOLY_CITY', 'RequirementSetId',  'PLAYER_HAS_KILMORPH_HOLY_CITY_SUBREQS');

INSERT INTO RequirementSets(RequirementSetId, RequirementSetType) VALUES
('PLAYER_HAS_VEIL_HOLY_CITY_SUBREQS', 'REQUIREMENTSET_TEST_ALL'),
('PLAYER_HAS_KILMORPH_HOLY_CITY_SUBREQS', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements(RequirementSetId, RequirementId) VALUES
('PLAYER_HAS_VEIL_HOLY_CITY_SUBREQS', 'REQUIRE_CITY_HAS_VEIL_HOLY_CITY_PROPERTY'),
('PLAYER_HAS_KILMORPH_HOLY_CITY_SUBREQS', 'REQUIRE_CITY_HAS_KILMORPH_HOLY_CITY_PROPERTY');

INSERT INTO Requirements(RequirementId, RequirementType) VALUES
('REQUIRE_CITY_HAS_VEIL_HOLY_CITY_PROPERTY', 'REQUIREMENT_PLOT_PROPERTY_MATCHES'),
('REQUIRE_CITY_HAS_KILMORPH_HOLY_CITY_PROPERTY', 'REQUIREMENT_PLOT_PROPERTY_MATCHES');
INSERT INTO RequirementArguments(RequirementId, Name, Value) VALUES
('REQUIRE_CITY_HAS_VEIL_HOLY_CITY_PROPERTY', 'PropertyName','RELIGION_BUDDHISM_HOLY_CITY'),
('REQUIRE_CITY_HAS_VEIL_HOLY_CITY_PROPERTY', 'PropertyMinimum','1'),
('REQUIRE_CITY_HAS_KILMORPH_HOLY_CITY_PROPERTY', 'PropertyName','RELIGION_CONFUCIANISM_HOLY_CITY'),
('REQUIRE_CITY_HAS_KILMORPH_HOLY_CITY_PROPERTY', 'PropertyMinimum','1');
...
('STATE_VEIL_ALLOW_MESHABBER', 'UnitType', 'SLTH_UNIT_MESHABBER'),                  -- also needs veil holy city
...
('CRUSADE_ALLOW_DEMAGOG', 'UnitType', 'SLTH_UNIT_DEMAGOG');
...
-- add a category for state religion in civpedia, and workforce, and change the names of the diplo, economic and mil policies.
...
('GOVERNMENTS', 'SLOT_SLTHCUL', 'LOC_PEDIA_GOVERNMENTS_PAGEGROUP_CULTURAL_POLICIES_NAME', 70),
('GOVERNMENTS', 'SLOT_SLTHREL', 'LOC_PEDIA_GOVERNMENTS_PAGEGROUP_STATE_RELIGION_POLICIES_NAME', 80);
