...
SOURCE_XLP = f'{SOURCE_PATH}/XLPs/Units.xlp'
DESTINATION_XLP = f'{DESTINATION_PATH}/XLPs/UnitBinParts.xlp'
UNIT = "UNIT_ZWEIHANDER"
#UNIT = "UNIT_TREBUCHET"

ASSET_ONLY = None
ASSET_ONLY = "Composite_Bow_European_Armor_A"
ASSET_ONLY = "Bowman_Armor"
ASSET_ONLY = "Yeoman_archer_armor_european_03_studded"
ASSET_ONLY = "Composite_Bow_Asian_Armor"
ASSET_ONLY = "Bowman_Bow"
ASSET_ONLY = "yeoman_crossbow_armor_B_padded"
ASSET_ONLY = "African_Axe_A"
# todo
ASSET_ONLY = "Berserker_HelmA"          # arthendain
ASSET_ONLY = "Briton_Helmet"            # harlequin
ASSET_ONLY = "Crusader_Helmet_F"        # Crusader?
ASSET_ONLY = "European_Medieval_Great_Helm_02_aragonese"        # basium
ASSET_ONLY = "Late_Byzantine_face_helmet_01" # Mimics
ASSET_ONLY = "Celtic_ceremonial_shield"         # Maros sheild?
ASSET_ONLY = "Celtic_classical_helm_02_horned"      # Maros, Berzerker_AxeA
ASSET_PER_BIN_MAX = 2
...
def transfer_unit_assets(asset_file_path):
    ...
    for source_filepath in cached:
        ...
        if os.path.exists(source_filepath):
            ...
            if ASSET_ONLY is not None:
                print(f'Copying {source_filepath.replace(SOURCE_PATH, "")}')
        else:
...
def main():
    if ASSET_ONLY is None:
        ...
        with open(source_unit_bins_artdef_path, 'r') as file:
            artdef_info = xmltodict.parse(file.read())
        with open(SOURCE_XLP, 'r') as file:
            xlp_src = file.read()
                            ...
                            if cached_culture:
                                ...
                                for idx, poss_bin in enumerate(possible_bins):
                                    if idx < ASSET_PER_BIN_MAX:
                                        ...
                                        if xlp_entry_name in xlp_src:
                                            xlp_info['m_XLPPath']['@text'] = 'unitbinaccessories.xlp'
                                            xlp_info['m_BLPPackage']['@text'] = 'UnitBinAccessories'
        ...
        asset_file_path = f'{SOURCE_PATH}/Assets/{ASSET_ONLY}.ast'
        transfer_unit_assets(asset_file_path)
