...
('CRAZED', 'SLTH_Todo', '80', NULL),
('DEMONIC_POSSESSION', 'SLTH_Todo', '80', NULL),
('ENRAGED', 'SLTH_Todo', '80', NULL),
('MUTATED', 'SLTH_Todo', '50', 'BUFF_MUTATED'),
...
('TREASURE', 'onGrantUnit', '80', 'SLTH_EQUIPMENT_TREASURE'),
