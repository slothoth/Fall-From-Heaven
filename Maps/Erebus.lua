...
--	FILE:	 Erebus2.lua
--	AUTHOR:  Slothoth
--	PURPOSE: Adapted version of Continents script
------------------------------------------------------------------------------
------------------------------------------------------------------------------
...
include "ErebusSupport"

local g_iW, g_iH;
local g_iFlags = {};
local g_continentsFrac = nil;

local plot_mapper = {[0]=g_PLOT_TYPE_OCEAN,
						[1]=g_PLOT_TYPE_LAND,
						[2]=g_PLOT_TYPE_HILLS,
						[3] = g_PLOT_TYPE_MOUNTAIN
					}
local terrain_mapper = {
	g_TERRAIN_TYPE_COAST,
g_TERRAIN_TYPE_OCEAN,
	g_TERRAIN_TYPE_GRASS_MOUNTAIN,
	g_TERRAIN_TYPE_SNOW_MOUNTAIN,
	g_TERRAIN_TYPE_TUNDRA_MOUNTAIN,
	g_TERRAIN_TYPE_DESERT_MOUNTAIN,
	g_TERRAIN_TYPE_PLAINS_MOUNTAIN,
...
-- probably unneeded
local hills_mapper ={
	[g_TERRAIN_TYPE_GRASS]=g_TERRAIN_TYPE_GRASS_HILLS,
	[g_TERRAIN_TYPE_PLAINS]=g_TERRAIN_TYPE_PLAINS_HILLS,
	[g_TERRAIN_TYPE_DESERT]=g_TERRAIN_TYPE_DESERT_HILLS,
	[g_TERRAIN_TYPE_TUNDRA]=g_TERRAIN_TYPE_TUNDRA_HILLS,
	[g_TERRAIN_TYPE_SNOW]=g_TERRAIN_TYPE_SNOWS_HILLS
}
------------------------------------------------------------------------------
...
function ApplyTerrain(plotTypes, terrainTypes)
	for i = 0, (g_iW * g_iH) - 1, 1 do
		...
		if (plot_mapper[plotTypes[i]] == g_PLOT_TYPE_HILLS) then			-- handles converting flat to hill?
...
function GenerateMap()
	...
	terrainTypes = createTerrainMap(g_iW, g_iH);
...
function GeneratePlotTypes()
	...
	local plotTypes = createPlotMap()		   -- do Erebus stuff
	return plotTypes;
end
