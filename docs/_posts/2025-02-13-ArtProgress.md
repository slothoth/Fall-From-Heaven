...
![Mana Resources!](../Images/resources_one.png)
![Mana Resources!](../Images/resources_two.png)
![Mana Resources!](../Images/resources_three.png)
...
![Pictured from left to right, top down: Archer, Maros, Flurry, Gilden, Mimic, Firebow, NightWatch, Arthedain, Crusader, Longbowman, Orthus, Basium, Beastmaster, Demagog](../Images/bowmanwarfare.png)
...
![Dragons were adapted from Prehistoric Wildlife's TRex. I plan to put on wings and add some fire breathing!](../Images/wildlife.png)
...
![The huge woman is just for dev, that asset is closed source, so I can't preview it except in game.](../Images/icons_one.png)
![](../Images/icons_two.png)
...
![Resource icons are currently not working on the frontend, hence the weird clipping.](../Images/setup_screen.png)
...
![](../Images/load_screen.png)
![](../Images/sheelba_diplo.png)
...
![img.png](../Images/Custom_Units.png)
...
<video width="560" height="315" controls>
  <source src="../Video/hi_def_movement_tornado_centaur_fire.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video width="560" height="315" controls>
  <source src="../Video/fire_cape_fail_pyre_zombie.mp4" type="video/mp4">
</video>
