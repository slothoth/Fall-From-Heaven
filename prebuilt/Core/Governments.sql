...
('MODIFIER_REPUBLIC_INCREASE_GPP_MULT', 'MODIFIER_PLAYER_CAPITAL_CITY_GPP_MULT', '0', NULL),
...
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_KILMORPH_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_KILMORPH'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_LEAVES_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_LEAVES'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_ORDER_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_ORDER'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_OVERLORDS_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_OVERLORDS'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_VEIL_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_VEIL'),
('MODIFIER_SLTH_POLICY_RELIGION_BUILDING_TEMPLE_OF_THE_EMPYREAN_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TEMPLE_OF_THE_EMPYREAN'),
('MODIFIER_PACIFISM_INCREASE_GPP_MULT', 'MODIFIER_PLAYER_CAPITAL_CITY_GPP_MULT', '0', NULL),
...
('MODIFIER_SLTH_POLICY_NATIONHOOD_BUILDING_TRAINING_YARD_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TRAINING_YARD'),
('MODIFIER_SACRIFICE_THE_WEAK_INCREASE_GPP_MULT', 'MODIFIER_PLAYER_CAPITAL_CITY_GPP_MULT', '0', NULL),
...
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_COURTHOUSE_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_COURTHOUSE'),
('MODIFIER_SLTH_POLICY_SOCIAL_ORDER_BUILDING_BASILICA_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_BASILICA'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_ADD_GOLDYIELD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', '0', NULL),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_MARKET_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_MARKET'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_TAVERN_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_TAVERN'),
('MODIFIER_SLTH_POLICY_CONSUMPTION_BUILDING_THEATRE_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_THEATRE'),
...
('MODIFIER_SLTH_POLICY_SCHOLARSHIP_BUILDING_LIBRARY_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_LIBRARY'),
...
('MODIFIER_SLTH_POLICY_MERCANTILISM_BUILDING_MARKET_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_MARKET'),
...
('MODIFIER_YieldType_ADD_CULTUREYIELD', 'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER', '0', NULL),
...
('MODIFIER_SLTH_POLICY_GUARDIAN_OF_NATURE_BUILDING_GROVE_ADD_AMENITIES', 'MODIFIER_SINGLE_CITY_ADJUST_ENTERTAINMENT', '0', 'SLTH_REQUIRES_CITY_HAS_GROVE');
...
('MODIFIER_YieldType_ADD_CULTUREYIELD', 'Amount', 'ARGTYPE_IDENTITY', '20'),
('MODIFIER_YieldType_ADD_CULTUREYIELD', 'YieldType', 'ARGTYPE_IDENTITY', 'YIELD_CULTURE'),
